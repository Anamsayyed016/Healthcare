  ...
  return (
    <section className="py-14 sm:py-20 bg-[#F0FDF4]/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] mb-3">Our Promise</h2>
          <p className="text-[#64748B]">
            PharmEFC&apos;s commitment to healthcare excellence, ethics, and enduring partnerships.
          </p>
        </motion.div>

        <div className="relative">
          <div className="hidden lg:block absolute top-8 left-[8%] right-[8%] h-px bg-linear-to-r from-[#3B82F6]/15 via-[#34D399]/25 to-[#3B82F6]/15" />
