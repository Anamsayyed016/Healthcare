...
import { processSteps } from '@/lib/data/services-page';
  ...
  return (
    <section className="py-14 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] mb-3">How We Work</h2>
          <p className="text-[#64748B]">
            A structured approach to delivering measurable healthcare outcomes.
          </p>
        </motion.div>
