      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-[#64748B] text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
            Healthcare organizations and partners are invited to collaborate with PharmEFC&apos;s
            leadership team to explore strategic opportunities in pharmaceuticals and healthcare
            excellence.
          </p>
